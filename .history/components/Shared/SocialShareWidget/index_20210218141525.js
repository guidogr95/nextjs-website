    ...
    return (
        <>
            <div className="social-share-wrapper" >
                <a href={`https://facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=${encodeURIComponent(url)}%2Fdocs%2Fplugins%2F&display=popup&ref=plugin&src=share_button`} target="_blank" rel="noopener noreferrer" className="share-btn facebook" >
                ...
                <a href={`https://twitter.com/intent/tweet?text=&url=${encodeURIComponent(url)}%23.YC68cTJpiO8.twitter&related=`} target="_blank" rel="noopener noreferrer" className="share-btn twitter" >
                    <div className="social-icon" >
                        <FaTwitter />
                    </div>
                    <div className="btn-underlay" >
