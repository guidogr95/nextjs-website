    ...
    return (
        <>
            <div className="social-share-wrapper" >
                <a href="/" target="_blank" rel="noopener noreferer" className="share-btn facebook" >
                ...
                <a href="/" target="_blank" rel="noopener noreferer" className="share-btn messenger" >
                    <div className="social-icon" >
                        <FaFacebookMessenger />
                    </div>
                    <div className="btn-underlay" >
                ...
                <a href="/" target="_blank" rel="noopener noreferer" className="share-btn twitter" >
                    <div className="social-icon" >
                        <FaTwitter />
                    </div>
                    <div className="btn-underlay" >
                ...
                <a href="/" target="_blank" rel="noopener noreferer" className="share-btn linkedin" >
                    <div className="social-icon" >
                        <FaLinkedinIn />
                    </div>
                    <div className="btn-underlay" >
            ...
            <style jsx>{`
                ...
                .messenger .social-icon :global(svg) {
