    ...
    return (
        <>
            <div className="social-share-wrapper" >
                <a href={`/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=${encodeURIComponent(url)}%2Fdocs%2Fplugins%2F&display=popup&ref=plugin&src=share_button`} target="_blank" rel="noopener noreferrer" className="share-btn facebook" >
