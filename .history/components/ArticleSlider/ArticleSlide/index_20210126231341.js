...
const ArticleSlide = ({ slideNumber, slidesLength, slideData }) => {
    ...
    // const thumbnail = `${apiUrl}${slideData.Thumbnail.formats.medium.url}`
    console.log(slideData.Thumbnail.formats)
                ...
                >
                    <div className="slide-content" >
                        ...
                        <div className="slide-image" >
                            <img alt={` slide${slideNumber}`} src={slideData.Thumbnail} />
                        </div>
                    </div>
                    <div
                    ...
                    >
                        ...
                        >
                            <SlideArrow color={colors.dayLight} />
                        </a>
                    </div>
                    <div
